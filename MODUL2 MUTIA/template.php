...
// silakan taruh code kalian di bawah
    if ($tinggi_badan == "" || $tinggi_badan == 0 || $berat_badan == "" || $berat_badan == 0 ) {
...
if (empty($error)) {
    ...
    // $berat = $berat_badan / 100;
    $kalku = $berat_badan / ($tinggi_m * $tinggi_m);

 
    if ($kalku <= 18.4) {
        $Status =  "Underweight";
    } elseif ($kalku >= 18.5 && $kalku <= 24.9) {
        $Status = "Normal";
    } elseif($kalku >= 25.0 && $kalku <= 39.9) {
        $Status =  "Overweight";
    } else {
        $Status =  "Obese";
}}
                ...
                <div class="card-body">
                    ...
                    <?php
                        if (isset($kalku)) {
                            ...
                            echo "Hasil BMI: " . number_format($kalku, 1);
                            echo " Status: ". $status;
                        }
