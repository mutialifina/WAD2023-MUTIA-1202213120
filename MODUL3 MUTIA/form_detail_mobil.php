...
<html lang="en">
    ...
    <body>
        <?php 
            ...
            $data = "SELECT * FROM showroom_mobil WHERE id = $id";
            $hasil = mysqli_query($koneksi, $data);
        
            if ($hasil) {
                // Ambil data mobil sebagai array asosiatif
                $mobil = mysqli_fetch_assoc($hasil);
            } else {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="string" class="form-control" name="brand_mobil" id="brand_mobil" value="<?= $mobil['brand_mobil']?>" placeholder="ngasal"disabled>
