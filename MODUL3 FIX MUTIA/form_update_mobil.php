...
<html lang="en">
    ...
    <body>
        <?php 
            ...
            $data = "UPDATE showroom_mobil SET $nama_mobil = 'nama_mobil', $brand_mobil = 'brand_mobil', $warna_mobil = 'warna_mobil', $tipe_mobil = 'tipe_mobil', $harga_mobil = 'harga_mobil' WHERE id = $id";
