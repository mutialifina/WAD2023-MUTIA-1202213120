...
// (3) Jika sudah coba deh kalian ambil data dari form (CLUE : pakai POST)
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO showroom_mobil (nama_mobil, brand_mobil, warna_mobil, tipe_mobil, harga_mobil) VALUES('$nama_mobil', '$brand_mobil', '$warna_mobil', '$tipe_mobil', '$harga_mobil)");
